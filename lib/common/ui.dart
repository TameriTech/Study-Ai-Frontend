...
class Ui {
  ...
  static InputDecoration getInputDecoration({String hintText = '', var errorText, required var prefixIcon, required Widget suffixIcon, required Widget suffix, var isFirst}) {
    return InputDecoration(
        ...
        filled: true,
        hintText: hintText,
        hintStyle: TextStyle(color: Color(0xff9C9C9C), fontSize: 14, fontFamily: 'Inter',),
  ...
  static InputDecoration getSearchInputDecoration({String hintText = '', required String errorText, required Widget suffixIcon, required Widget prefixIcon, required Widget suffix}) {
    return InputDecoration(
      ...
      border: OutlineInputBorder(borderSide:BorderSide(width: 1, style: BorderStyle.solid, color: Color(0xffE1E4EA) ), borderRadius: BorderRadius.circular(30),),
      focusedBorder: OutlineInputBorder(borderSide:BorderSide(width: 1, style: BorderStyle.solid, color: Color(0xffE1E4EA)), borderRadius: BorderRadius.circular(30)),
      enabledBorder: OutlineInputBorder(borderSide:BorderSide(width: 1, style: BorderStyle.solid,color: Color(0xffE1E4EA)), borderRadius: BorderRadius.circular(30)),
      suffixIcon: suffixIcon,
      suffix: suffix,
      //errorText: errorText,
