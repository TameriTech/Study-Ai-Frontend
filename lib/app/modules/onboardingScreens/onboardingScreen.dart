                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(AppLocalizations.of(context).learn_revise_progress,
                              style: Get.textTheme.labelMedium, textAlign: TextAlign.center,).marginSymmetric(horizontal: 20, vertical: 20),
                          ...
                          GestureDetector(
                              ...
                              child: Text(
                                  ...
                                  style: TextStyle(color: Colors.black,
                                      ...
                                      fontSize: 16) )).marginOnly(top: Get.height/25, bottom: Get.height/10)
